...
Allocate roughly 2–4 GB to PostgreSQL/services and leave headroom for the web build, worker and browser. Start worker concurrency at 2; provider-specific budgets and rate limits are separate. Stream imports and enforce file limits instead of loading arbitrary reports/images into memory.
